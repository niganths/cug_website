...
import eventsData from '../util/eventlist.js';
              ...
              <div className="flex flex-col w-full bg-white rounded shadow-lg sm:w-3/4 md:w-1/2 lg:w-3/5">
                ...
                <div className="flex flex-col w-full md:flex-row">
                  ...
                  <div className="p-4 font-normal text-gray-800 md:w-3/4">
                    <h1 className="mb-4 text-4xl font-bold leading-none tracking-tight text-zinc-900 text-center ">{event.title}</h1>
                    <p className="leading-normal text-emerald-600 text-x2 text-justify font-bold font-serif">{event.description}</p>
                    <div className="flex flex-row items-center mt-4 text-gray-700">
                      <div className="w-1/2 text-black text-x1" >{event.location}</div>
